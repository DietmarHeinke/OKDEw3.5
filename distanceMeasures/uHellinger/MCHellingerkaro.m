function H = MCHellingerkaro( f1, f2, N )
% 
% Matej Kristan (2007)
...
pdf_f1 = evaluateDistributionAt( f1.Mu, f1.w, f1.Cov, X ) ;
pdf_f2 = evaluateDistributionAt( f2.Mu, f2.w, f2.Cov, X ) ;
...
for i = 1 : length(weights)
    ...
    covariance=cell2mat(covariance);
