...
% pdf_f20 = evaluateDistributionAt( f2.mu, f2.weights, f2.covariances, X ) ;

pdf_f1 = evaluateDistributionAt1D(  f1.mu, f1.weights, f1.covariances, X ) ;
pdf_f2 = evaluateDistributionAt1D(  f2.mu, f2.weights, f2.covariances, X ) ;
...
% pdf_f20 - pdf_f2 
%  
% Y = (sqrt(pdf_f1) - sqrt(pdf_f2)).^2 ;

Y = sqrt(pdf_f2./pdf_f1) ;
% Y = (sqrt(pdf_f1) - sqrt(pdf_f2)).^2./pdf_f1 ;
